...
export const content = {
  ...
  hero: {
    ...
    sub: `Answer 5 questions about them. We turn your memories into a real, studio-quality song — delivered to your phone in 1 hour. From $${config.price.core}.`,
    ...
    steps: {
      ...
      vibe: {
        ...
        styles: [
          ...
          { value: "R&B", preview: "/audio/demo-pop.mp3" },
          { value: "Rock", preview: "/audio/demo-pop.mp3" },
        ],
        moodLabel: "Mood",
